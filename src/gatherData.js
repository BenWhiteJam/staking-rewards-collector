...
export async function gatherData(
    start, end, network, name, address, currency, priceData, startBalance, ticker, subscan_apikey, cryptocompare_apikey, apiSleepDelay, priceApi
) {
    ...
    obj = initializeObject(daysArray, network, name, address, currency, startBalance, ticker, subscan_apikey, cryptocompare_apikey, apiSleepDelay, priceApi, start, end);
